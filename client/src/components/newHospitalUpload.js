...
const NewHospitalUpload = () => {
  ...
  async function createNewPatient() {
    kalp.methods.setPatient(newPatient.id, newPatient.name, newPatient.age, newPatient.contact, newPatient.useraddress).send({ from: newPatient.id })
      .then(({ data }) => {
  ...
  return (
    <div>
      <Grid>
        <section className="" style={{ backgroundColor: "aquamarine",paddingTop:50,paddingBottom:50,paddingRight:20,paddingLeft:20,borderRadius:20 }}>
          <h2 className="name display-1" style={{color:"white"}}>Medical Chain, London</h2>
          <h2 className="display-3 " style={{color:"white"}}><b>Patients : </b>{patientCount}</h2>
        </section>
      </Grid>
      <Row>
        <Col sm={6} smOffset={3}>
          ...
          {state.addPatient ? (
            <Col sm={8} smOffset={2} className="newPat">
              <form >
                ...
                <Button onClick={ev => { createNewPatient() }}>
                  Submit
                </Button>
              </form>
            </Col>
            ...
            <Col sm={8} smOffset={2} className="newPat">
              <Button onClick={ev => setState({ ...state, addPatient: true })}>Add a Patient</Button>
            </Col>
          )}
        </Col>
      </Row>
      <Tabs defaultActiveKey={0} id="options" className="container">
        <Tab eventKey={0} title="Patient Details">
...
export default NewHospitalUpload
